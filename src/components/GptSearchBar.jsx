...
const GptSearchBar = () => {
  ...
  return (
    <div className="pt-[15%] flex justify-center">
      <form
        className="bg-black/60 w-1/2 py-4 px-4 grid grid-cols-12 gap-2 rounded-lg shadow-md"
      ...
      >
        <input
          ...
          className="col-span-10 px-4 py-2 rounded-md outline-none bg-white text-black"
        />
        <button
          type="submit"
          className="col-span-2 bg-orange-400 text-black  rounded-md hover:bg-orange-500 transition"
